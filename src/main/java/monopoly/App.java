...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(String.format("Average number of properties purchased: %.2f",
                (double) purchasedProperties / ITERATIONS));
        System.out.println(String.format("%% of games where Indiana Avenue is purchased: %.2f%%",
                ((double) indianaAvenuePurchases / ITERATIONS) * 100));
        System.out.println();

...
/**
 * Class for building Cost objects from constraints given in plain text.
 * 
 */
public class CostFactory {

    final static Pattern FIXED_AMOUNT_PATTERN = Pattern
            .compile("^(\\d{1,100}) or (\\d{1,2})\\% of total cash whichever is greater");
